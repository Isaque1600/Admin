...
if (isset($data['result'])) {
    if ($data['result'] == "success") {
        ...
        $result['text'] = "O sistema {$dataForm['nome']} foi cadastrado com sucesso!";
    } elseif ($data['result'] == "23000") {
        $result['title'] = "Sistema já cadastrado no Banco de Dados!";
        $result['text'] = "O sistema {$dataForm['nome']} já está cadastrado no banco de dados";
    } else {
...
<body class="<?php echo (isset($_COOKIE['theme'])) ? $_COOKIE['theme'] . "-theme" : "" ?>">
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <a href="<?php echo DEFAULT_URL ?>sistemas/listar" title="Sistemas" style="display: flex;"
                class="systems-pages">
                <i data-feather="list"></i>
                <p>Listar</p>
            </a>
            <a href="<?php echo DEFAULT_URL ?>sistemas/cadastrar" title="Sistemas"
        ...
        <div class="content">
            <div class="form-section">
                ...
                <!-- Form Top End -->
                <div class="form-register systems">
